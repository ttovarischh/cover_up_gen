export class Slider {
    ...
    constructor({ DOMselector, sliders }) {
        ...
        this.arcBgFractionColor = 'black';                        // Arc fraction color for background slider
        this.handleFillColor = '#fff';                              // Slider handle fill color
        this.handleStrokeColor = '#fff';                         // Slider handle stroke color
