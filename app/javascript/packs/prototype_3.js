...
document.addEventListener('DOMContentLoaded', () => {
  ...
  circle_one.classList.add('circle_one', 'top')
  circle_two.classList.add('circle_two', 'top')
  ...
  circle_one.addEventListener('click', () => {
    circle_one.classList.toggle("top");
    circle_one.classList.toggle("down_one");
  })

  circle_two.addEventListener('click', () => {
    circle_two.classList.toggle("top");
    circle_two.classList.toggle("down_two");
  })
